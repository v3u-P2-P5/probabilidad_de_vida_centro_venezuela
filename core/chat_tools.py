...
TOOLS_SCHEMA = [
    ...
    _fn("list_help_resources",
        "Lista hospitales, clínicas, bomberos y ambulancias mapeados en una zona (OSM), con teléfono y dirección si están.",
        {"zona": _ZONA, "tipo": {"type": "string",
            "enum": ["hospital", "clinic", "fire_station", "ambulance_station", "todos"]},
